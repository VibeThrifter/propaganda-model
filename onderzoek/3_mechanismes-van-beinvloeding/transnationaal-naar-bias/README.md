...
> en *dát* het NL-nieuws daarheen leunt — staat in streng 1
> (`../../1_in-voordeel-van-welke-eliten/03_transnationale-structuren/`, m.n. `3.1`).

> Bewijs **extern** gezocht (deep-research 29-06, **twee** runs: eerste pass + re-verify). Beide
...
(journalisten volgen het regeringsframe niet slaafs). NL-specifiek bevestigd: alleen dat ANP 50–75%
van het politieke nieuws levert. De NL-*framing*- en *denktank*-aanwijzingen (Clingendael ~75%
staatsgefinancierd, HCSS met NAVO/EU als partners; NL-Irak-indexing; Fengler 13-landen incl. NL)
bleven na **twee** runs **onbevestigd**. Netto: de **minst hard-onderbouwde pijler voor NL** —
geen verificatie- maar een bron-kwestie geworden. Zie `00_netto-oordeel.md`.

## Mappenstructuur
```
transnationaal-naar-bias/
├── README.md                          ← dit bestand
├── 00_netto-oordeel.md                ← vraag + (voorlopig) oordeel + bewijskracht + koppeling
├── 01_wire-agency-en-indexing.md      ← SCHAKEL 1+2: ANP/Westerse wires + indexing-model
├── 02_geopolitiek-frame-en-denktanks.md ← SCHAKEL 3+4: dichotome framing + Atlantische denktanks
└── bronnen/
    └── bronnenregister.md             ← bevestigd vs te-verifiëren + NL/analogie
```

## Statuslegenda
- **kerntekst** — adversarieel bevestigd (3-0).
- **te-verifiëren** — opgehaald, stem afgebroken door de cap (0-0 abstain) — *niet* weerlegd, maar
